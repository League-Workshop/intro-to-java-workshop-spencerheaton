...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor == Bcolor) {scare();}
		//13. If the mouse is on the end color
		if(mouseColor == Wcolor) {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("sound.html"));
		...
		showScaryImage("newscaryimage.jpg");
	}
